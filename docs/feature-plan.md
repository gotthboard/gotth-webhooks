...
| Lifecycle | WHK-011/014 | shared admission lock/count, drain, owned transport cleanup | closed precedence, pause before first transport and between retries, drain, concurrent/repeated close, race/allocation |
